...
namespace CS.Edu.Tests.ReactiveTests
{
    ...
    public class ColdHotTests
    {
        ...
        public void ColdObservable()
        {
            ...
            CollectionAssert.AreEqual(new long[] {0, 1, 2, 3, 4}, result1);
            CollectionAssert.AreEqual(new long[] {0, 1, 2}, result2);
        }
        ...
        public void HotObservable()
        {
            ...
            CollectionAssert.AreEqual(new long[] {1, 2}, result1);
            CollectionAssert.AreEqual(new long[] {2}, result2);
        }
        ...
        public void Publish()
        {
            ...
            CollectionAssert.AreEqual(new long[] {0, 1, 2, 3, 4}, result1);
            CollectionAssert.AreEqual(new long[] {3, 4}, result2);
        }
    }
}